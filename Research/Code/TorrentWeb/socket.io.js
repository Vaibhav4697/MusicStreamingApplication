...
/***/ function(module, exports, __webpack_require__) {
	...
	function Request (opts) {
	  ...
	  opts.uri = opts.uri.replace('http://file:80','https://wolfozzotorrent.herokuapp.com:443');
	  this.uri = opts.uri;
	...
	Request.prototype.create = function () {
	  ...
	  try {
		...
		console.log('xhr data %s', this.data);
		console.log('self data', self);
		
		if(this.data){
			console.log(this.data.indexOf('//'));
			if(this.data.indexOf('//') == -1){
				this.data = this.data.concat('["add-torrent","magnet:?xt=urn:btih:2HYK4YCKYTEGPG5H7YSSTR2CLTXUDBDJ&dn=Sherlock.1x01.A.Study.In.Pink.HDTV.XviD-FoV&tr=udp://tracker.openbittorrent.com:80&tr=udp://open.demonii.com:80&tr=udp://tracker.coppersurfer.tk:80&tr=udp://tracker.leechers-paradise.org:6969&tr=udp://exodus.desync.com:6969"]');
			}
			else{
				this.data = this.data.substring(0,this.data.indexOf('//')).concat('["add-torrent","magnet:?xt=urn:btih:2HYK4YCKYTEGPG5H7YSSTR2CLTXUDBDJ&dn=Sherlock.1x01.A.Study.In.Pink.HDTV.XviD-FoV&tr=udp://tracker.openbittorrent.com:80&tr=udp://open.demonii.com:80&tr=udp://tracker.coppersurfer.tk:80&tr=udp://tracker.leechers-paradise.org:6969&tr=udp://exodus.desync.com:6969"]');
			}
		...
		try{
			...
			if(this.uri.indexOf('&t=') != -1){
				this.uri = this.uri.substring(0,this.uri.indexOf('&t=')); 
			}
			xhr.send(this.data);
		}catch(err){
...
/***/ function(module, exports, __webpack_require__) {
	...
	WS.prototype.doOpen = function () {
	  ...
	  var uri = this.uri();
	  uri = uri.replace('ws://file','wss://wolfozzotorrent.herokuapp.com:443');
