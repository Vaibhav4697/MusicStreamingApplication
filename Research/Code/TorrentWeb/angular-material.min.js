...
! function(e, t, n) {
    ...
    function() {
        function e(e, n, o, r, i) {
            ...
            return a = {
                translate3d: function(e, t, o, r) {
                    function i(n) {
                        return e.removeClass(r.transitionInClass).addClass(r.transitionOutClass).css(n || t), a.waitTransitionEnd(e)
                    }
                    return e.css(t), n(function() {
                        e.css(o).addClass(r.transitionInClass)
                    }), a.waitTransitionEnd(e).then(function() {
                        return i
                    })
                },
                waitTransitionEnd: function(e, t) {
                    ...
                    return o(function(o, a) {
                        function d(t) {
                            t && t.target !== e[0] || (t && r.cancel(c), e.off(i.CSS.TRANSITIONEND, d), o())
                        }
                        t = t || {};
                        var c = r(d, t.timeout || n);
                ...
                calculateZoomToOrigin: function(n, o) {
                    ...
                    if (r) {
                        var l = a.clientRect(r) || a.copyRect(o.bounds),
                            m = a.copyRect(n[0].getBoundingClientRect()),
                            s = a.centerPointFor(m),
                            u = a.centerPointFor(l);
                        c = d({
                            centerX: u.x - s.x,
                            centerY: u.y - s.y,
                            scaleX: Math.min(.5, l.width / m.width),
                            scaleY: Math.min(.5, l.height / m.height)
                        })
                    }
                    return c
                },
                toTransformCss: function(e, n) {
                    var o = {};
                    return t.forEach(i.CSS.TRANSFORM.split(" "), function(t) {
                        o[t] = e
                    }), n && (o.transition = "all 0.4s cubic-bezier(0.25, 0.8, 0.25, 1) !important"), o
                },
        ...
        t.module("material.core").factory("$$mdAnimate", ["$$rAF", "$q", "$timeout", "$mdConstant", function(t, n, o, r) {
            return function(i) {
                return e(i, t, n, o, r)
            }
        }])
        ...
        function e(e, n) {
            ...
            function b(e, o, r, a) {
                ...
                for (var d = u(o);;) {
                    ...
                    var c = d + (e ? -1 : 1),
                        l = null;
                    if (i(c) ? l = E[c] : n && (l = e ? h() : f(), c = u(l)), null === l || c === a) return null;
                    if (r(l)) return l;
    ...
    function() {
        function e(e, n, o) {
            ...
            function a(e) {
                var t = p[e] = o.matchMedia(e);
                return t.addListener(d), f[t.media] = !!t.matches
            }
    ...
    function() {
        var o = 0;
        t.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", "$q", "$compile", "$window", "$mdConstant", "$$rAF", "$rootScope", "$$mdAnimate", function(r, i, a, d, c, l, m, s, u, p) {
            function f(e) {
                return e[0] || e
            }
            var h = {
                ...
                clientRect: function(e, t, n) {
                    var o = f(e);
                    t = f(t || o.offsetParent || document.body);
                ...
                scrollTop: function(e) {
                    e = t.element(e || i[0].body);
                    var o = e[0] == i[0].body ? i[0].body : n,
                        r = o ? o.scrollTop + o.parentElement.scrollTop : 0;
                ...
                disableScrollAround: function(e, n) {
                    function o(e) {
                        ...
                        e = t.element(e || d)[0];
                        var r = 50,
                            a = t.element('<div class="md-scroll-mask" style="z-index: ' + r + '">  <div class="md-scroll-mask-bar"></div></div>');
                        return e.appendChild(a[0]), a.on("wheel", o), a.on("touchmove", o), i.on("keydown", n),
                            function() {
                                a.off("wheel"), a.off("touchmove"), a[0].parentNode.removeChild(a[0]), i.off("keydown", n), delete h.disableScrollAround._enableScrolling
                            }
                    }
                    ...
                    return h.disableScrollAround._enableScrolling = function() {
                        --h.disableScrollAround._count || (c(), l(), delete h.disableScrollAround._enableScrolling)
                    }
                },
                ...
                createBackdrop: function(e, t) {
                    return c(h.supplant('<md-backdrop class="{0}">', [t]))(e)
                },
                ...
                nextTick: function(e, t) {
                    ...
                    var o = h.nextTick,
                        r = o.timeout,
                        i = o.queue || [];
                    return i.push(e), null == t && (t = !0), o.digest = o.digest || t, o.queue = i, r || (o.timeout = a(n, 0, !1))
                }
            };
            return h.dom.animator = p(h), h
    ...
    function() {
        ...
        function o(n, o, r) {
            ...
            var c = navigator.userAgent || navigator.vendor || e.opera,
                m = c.match(/ipad|iphone|ipod/i),
                s = c.match(/android/i),
                u = "undefined" != typeof e.jQuery && t.element === e.jQuery,
                h = {
                    handler: a,
                    register: i,
                    isHijackingClicks: (m || s) && !u && !f
                };
        ...
        function a(e, n) {
            function o(e, t) {
                var o;
                for (var r in p) o = p[r], o instanceof n && ("start" === e && o.cancel(), o[e](t, s))
            }
            ...
            t.element(document).on(m, r).on(f, i).on(b, a).on("$$mdGestureReset", function() {
                u = s = null
            })
        }
        ...
        function e() {
            function e(e) {
                ...
                function i(n, o) {
                    ...
                    function i(t, n) {
                        var r = {};
                        return r[e] = s, o.invoke(t || function() {
                            return n
                        }, {}, r)
                    }
                    var a, l, m = n(),
            ...
            function o(e, o, r, i, a, d, c, l, m, s) {
                function u(e) {
                    return e && t.isString(e) ? e.replace(/\{\{/g, p).replace(/}}/g, f) : e
                }
                var p = c.startSymbol(),
                    f = c.endSymbol(),
                    h = "{{" === p && "}}" === f,
                ...
                return function() {
                    ...
                    function s(e) {
                        var t = E.shift();
                        return t ? (t.remove(e || g, !1)["catch"](function(e) {}), t.deferred.promise) : o.when(e)
                    }

                    function u(e) {
                        var t = E.shift();
                        return t ? (t.remove(e || h, !0)["catch"](function(e) {}), t.deferred.promise) : o.when(e)
                    }
                    ...
                    function p(c) {
                        function s() {
                            return o(function(e, t) {
                                ...
                                h(c).then(function(t) {
                                    T = g(t, c), C = M(T, c).then(e, n)
                                })
                            })
                        }

                        function u(e, t) {
                            return c.cancelAutoHide && c.cancelAutoHide(), o(function(n, r) {
                                function i() {
                                    A.deferred.resolve(e), n(e)
                                }

                                function a(e) {
                                    A.deferred.reject(e), r(e)
                                }
                                o.when(C)["finally"](function() {
                                    $(c.element, c).then(function() {
                                        t && a(e) || i()
                                    }, a)
                                })
                            })
                        ...
                        function p(e) {
                            return e = e || {}, e.template && (e.template = b(e.template)), t.extend({
                                preserveScope: !1,
                        ...
                        function v() {
                            var e, o = t.noop;
                            c.hideDelay && (e = i(f.hide, c.hideDelay), o = function() {
                                i.cancel(e)
                            }), c.cancelAutoHide = function() {
                                o(), c.cancelAutoHide = n
                            }
                        }

                        function M(e, n) {
                            var r = n.onComplete || t.noop;
                            return o(function(t, i) {
                                try {
                                    o.when(n.onShow(n.scope, e, n)).then(function() {
                                        r(n.scope, e, n), v(), t(e)
                                    }, i)
                                } catch (a) {
                                    i(a.message)
            ...
            return e.$get = o, o.$inject = ["$document", "$q", "$rootScope", "$timeout", "$rootElement", "$animate", "$interpolate", "$mdCompiler", "$mdTheming", "$log"], e
        }
    ...
    function() {
        ...
        function n(e, n, o) {
            function r(r, i, a) {
                function d() {
                    var e = i.data("$mdRippleContainer");
                    return e ? e : (e = t.element('<div class="md-ripple-container">'), i.append(e), i.data("$mdRippleContainer", e), e)
                }
                ...
                function l(e, t) {
                    E.splice(E.indexOf(e), 1), 0 === E.length && d().css({
                        backgroundColor: ""
                    }), n(function() {
                        e.remove()
                    }, t, !1)
                ...
                function s(r, l) {
                    function s(e) {
                        var n = t.element('<div class="md-ripple" data-counter="' + g++ + '">');
                        return E.unshift(n), v.unshift({
                            animating: !0
                        }), f.append(n), e && n.css(e), n
                    }

                    function u(e, t) {
                        var n, o, r, i = f.prop("offsetWidth"),
                            d = f.prop("offsetHeight");
                        return a.isMenuItem ? o = Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2)) : a.outline ? (r = T.getBoundingClientRect(), e -= r.left, t -= r.top, i = Math.max(e, i - e), d = Math.max(t, d - t), o = 2 * Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2))) : (n = a.fullRipple ? 1.1 : .8, o = Math.sqrt(Math.pow(i, 2) + Math.pow(d, 2)) * n, a.fitRipple && (o = Math.min(d, i, o))), o
                    }
                    ...
                    function p(e, t, n) {
                        ...
                        return a.outline ? (i.width = 0, i.height = 0) : i.marginLeft = i.marginTop = e * -.5 + "px", a.center ? i.left = i.top = "50%" : (i.left = Math.round((t - r.left) / f.prop("offsetWidth") * 100) + "%", i.top = Math.round((n - r.top) / f.prop("offsetHeight") * 100) + "%"), i
                    }
                    y = c(i.attr("md-ink-ripple")) || c(e.getComputedStyle(a.colorElement[0]).color || "rgb(0, 0, 0)");
                    var f = d(),
                        b = u(r, l),
                        M = p(b, r, l),
                        $ = s(M),
                        A = E.indexOf($),
                        C = v[A] || {};
                    return h = b, C.animating = !0, o.nextTick(function() {
                        a.dimBackground && f.css({
                            backgroundColor: y
                        }), $.addClass("md-ripple-placed md-ripple-scaled"), $.css(a.outline ? {
                            borderWidth: .5 * b + "px",
                            marginLeft: b * -.5 + "px",
                            marginTop: b * -.5 + "px"
                        } : {
                ...
                function u(e) {
                    f() && (s(e.pointer.x, e.pointer.y), A = !0)
                }
                ...
                function f() {
                    ...
                    var t = T.parentNode,
                        n = t && t.parentNode,
                        o = n && n.parentNode;
                    return !(e(T) || e(t) || e(n) || e(o))
                }
                if (i.controller("mdNoInk")) return t.noop;
                a = t.extend({
                    colorElement: i,
                    mousedown: !0,
                    hover: !0,
                ...
                var h, b = i.controller("mdInkRipple") || {},
                    g = 0,
                    E = [],
                    v = [],
                    M = i.attr("md-highlight"),
                    $ = !1,
                    A = !1,
                    T = i[0],
                    C = i.attr("md-ripple-size"),
                    y = c(i.attr("md-ink-ripple")) || c(a.colorElement.length && e.getComputedStyle(a.colorElement[0]).color || "rgb(0, 0, 0)");
                switch (C) {
                    case "full":
                        a.fullRipple = !0;
                        break;
                ...
                return a.mousedown && i.on("$md.pressdown", u).on("$md.pressup", p), b.createRipple = s, M && r.$watch(M, function(e) {
                        $ = e, $ && !E.length && o.nextTick(function() {
                            s(0, 0)
                        }), t.forEach(E, m)
                    }),
                    function() {
                        i.off("$md.pressdown", u).off("$md.pressup", p), d().remove()
                    }
            }
            return {
                attach: r
        ...
        t.module("material.core").factory("$mdInkRipple", n).directive("mdInkRipple", e).directive("mdNoInk", o()).directive("mdNoBar", o()).directive("mdNoStretch", o()), e.$inject = ["$mdButtonInkRipple", "$mdCheckboxInkRipple"], n.$inject = ["$window", "$timeout", "$mdUtil"]
    }(),
    function() {
        ! function() {
            function e(e) {
            ...
            function c(e) {
                function n(e) {
                    if (e = 0 === arguments.length ? !0 : !!e, e !== o.isDark) {
                        o.isDark = e, o.foregroundPalette = o.isDark ? f : p, o.foregroundShadow = o.isDark ? h : b;
                        var n = o.isDark ? T : A,
                            r = o.isDark ? A : T;
        ...
        function a(e) {
            ...
            if (r && 0 !== a.length) {
                ...
                var d = {},
                    ...
                    p = new RegExp("md-(" + M.join("|") + ")", "g");
                M.forEach(function(e) {
                    d[e] = ""
                }), l.forEach(function(e) {
                    for (var t, n = (e.match(p), 0); t = M[n]; n++)
    ...
    function() {
        ...
        function n(e) {
            function n(e, n, i, a, d, c, l) {
                function m(o, r, l) {
                    r = i.extractElementByName(r, "md-bottom-sheet"), p = i.createBackdrop(o, "md-bottom-sheet-backdrop md-opaque"), p.on("click", function() {
                        i.nextTick(d.cancel, !0)
                    }), a.inherit(p, l.parent), e.enter(p, l.parent, null);
                    var m = new u(r, l.parent);
                    return l.bottomSheet = m, l.targetEvent && t.element(l.targetEvent.target).blur(), a.inherit(m.element, l.parent), l.disableParentScroll && (l.lastOverflow = l.parent.css("overflow"), l.parent.css("overflow", "hidden")), e.enter(m.element, l.parent).then(function() {
                ...
                function s(n, o, r) {
                    var i = r.bottomSheet;
                    return e.leave(p), e.leave(i.element).then(function() {
                ...
                function u(e, t) {
                    ...
                    var s = l.register(t, "drag", {
                        horizontal: !1
                    });
                    return t.on("$md.dragstart", a).on("$md.drag", c).on("$md.dragend", m), {
                        element: e,
                        cleanup: function() {
                            s(), t.off("$md.dragstart", a).off("$md.drag", c).off("$md.dragend", m)
                        }
                    }
                }
                var p;
    ...
    function() {
        t.module("material.components.backdrop", ["material.core"]).directive("mdBackdrop", ["$mdTheming", "$animate", "$rootElement", "$window", "$log", "$$rAF", "$document", function(e, t, n, o, r, i, a) {
            function d(d, l, m) {
                var s = o.getComputedStyle(a[0].body);
                if ("fixed" == s.position) {
                    var u = parseInt(s.height, 10) + Math.abs(parseInt(s.top, 10));
                    l.css({
                        height: u + "px"
                    })
                }
    ...
    function() {
        function e(e, n, o, r, i, a, d) {
            function c(n, c) {
                return c.type = "checkbox", c.tabindex = c.tabindex || "0", n.attr("role", c.type),
                    function(n, c, m, s) {
                        function u(e, t, o) {
                        ...
                        function p(e) {
                            ...
                            (t === r.KEY_CODE.SPACE || t === r.KEY_CODE.ENTER) && (e.preventDefault(), c.hasClass("md-focused") || c.addClass("md-focused"), f(e))
                        }
                        ...
                        s = s || a.fakeNgModel(), i(c), m.ngChecked && n.$watch(n.$eval.bind(n, m.ngChecked), s.$setViewValue.bind(s)), u("ngDisabled", "tabindex", {
                            ...
                            on: t.noop,
                            0: {}
                        }, m, [s]), n.mouseActive = !1, c.on("click", f).on("keypress", p).on("mousedown", function() {
            ...
            function o(e, n, o, r, i, a, d, c) {
                function l(e, n, r) {
                    function i() {
                        ...
                        if (r.focusOnOpen) {
                            var o = "alert" === r.$type ? n.find("md-dialog-content") : e();
                            o.focus()
                        }
                    }
                    return n = o.extractElementByName(n, "md-dialog"), t.element(a[0].body).addClass("md-dialog-is-showing"), s(n, r), f(n.find("md-dialog"), r), p(e, n, r), g(n, r).then(function() {
                        u(n, r), h(n, r), i()
                    })
                }
                ...
                function s(e, n) {
                    ...
                    n.origin = t.extend({}, r, n.origin || {});
                    var i = t.element((n.targetEvent || {}).target);
                    i && i.length && (n.origin.element = i, n.origin.bounds = i[0].getBoundingClientRect(), n.origin.focus = function() {
                        i.focus()
                    }), n.parent = t.element(n.parent || c), n.disableParentScroll && (n.restoreScroll = o.disableScrollAround(e, n.parent))
                }
                ...
                function p(e, t, n) {
                    n.hasBackdrop && (n.backdrop = o.createBackdrop(e, "md-dialog-backdrop md-opaque"), i.enter(n.backdrop, n.parent)), n.hideBackdrop = function() {
                        n.backdrop && i.leave(n.backdrop), n.disableParentScroll && n.restoreScroll(), n.hideBackdrop = null
                    }
                }
    ...
    function() {
        ! function() {
            function e() {
                ...
                function t(e, t, n, o) {
                    function r() {
                        d.direction = d.direction || "down", d.isOpen = d.isOpen || !1
                    }

                    function i() {
                        t.on("mouseenter", d.mouseenter), t.on("mouseleave", d.mouseleave)
                    }
                    ...
                    d.open = function() {
                        ...
                        !d.moused && e.$evalAsync("vm.isOpen = false")
                    }, d.mouseenter = function() {
                        d.moused = !0, d.open()
                    }, d.mouseleave = function() {
                        d.moused = !1, d.close()
                    }, r(), i(), a(), o.nextTick(function() {
                        n.addClass(t, "md-noop")
                    })
                }
                return t.$inject = ["$scope", "$element", "$animate", "$mdUtil"], {
                    restrict: "E",
                    scope: {
            ...
            function n() {
                function e(e) {
                    var n = e[0],
                        ...
                        r = n.querySelectorAll(".md-fab-action-item"),
                        i = n.querySelector(".md-css-variables"),
                        a = i.style.zIndex;
                    t.forEach(r, function(e, t) {
                        var n = e.style;
                        n.transform = n.webkitTransform = "", n.transitionDelay = "", n.opacity = 1, n.zIndex = r.length - t + a
            ...
            t.module("material.components.fabSpeedDial", ["material.core", "material.components.fabTrigger", "material.components.fabActions"]).directive("mdFabSpeedDial", e).animation(".md-fling", n).animation(".md-scale", o).service("mdFabSpeedDialFlingAnimation", n).service("mdFabSpeedDialScaleAnimation", o)
        }()
    }(),
    function() {
        ! function() {
            function e() {
                return {
                    ...
                    compile: function(e, n) {
                        var o = e.children();
                        return o.attr("ng-repeat") ? o.addClass("md-fab-action-item") : o.wrap('<div class="md-fab-action-item">'),
                            function(e, n, o, r) {
                                var i = r[0] || r[1];
                                i && t.forEach(n.children(), function(e) {
                                    e = t.element(e).children()[0], t.element(e).on("focus", i.open), t.element(e).on("blur", i.close)
                                })
                            }
                    }
                }
        ...
        ! function() {
            ...
            function o() {
                function n(n, o, r) {
                    ...
                    if (c && d) {
                        var s = e.getComputedStyle(c).getPropertyValue("background-color"),
                            u = i.offsetWidth,
                            p = (i.offsetHeight, 2 * u);
                        d.style.backgroundColor = s, d.style.borderRadius = u + "px", a.isOpen ? (d.style.width = p + "px", d.style.height = p + "px", d.style.top = -(p / 2) + "px", n.hasClass("md-left") && (d.style.left = -(p / 2) + "px", d.style.right = null), n.hasClass("md-right") && (d.style.right = -(p / 2) + "px", d.style.left = null), d.style.transitionDelay = "0ms", l && (l.style.transitionDelay = ".3s"), t.forEach(m, function(e, t) {
                            e.style.transitionDelay = 25 * (m.length - t) + "ms"
                        })) : (d.style.width = c.offsetWidth + "px", d.style.height = c.offsetHeight + "px", d.style.top = "0px", n.hasClass("md-left") && (d.style.left = "0px", d.style.right = null), n.hasClass("md-right") && (d.style.right = "0px", d.style.left = null), d.style.transitionDelay = "200ms", l && (l.style.transitionDelay = "0ms"), t.forEach(m, function(e, t) {
            ...
            t.module("material.components.fabToolbar", ["material.core", "material.components.fabTrigger", "material.components.fabActions"]).directive("mdFabToolbar", n).animation(".md-fab-toolbar", o).service("mdFabToolbarAnimation", o)
        }()
    }(),
    function() {
        ! function() {
                            ...
                            return {
                                ...
                                tiles: e.map(function(e, n) {
                                    return {
                                        ...
                                        style: f(e.position, e.spans, i.colCount, i.rowCount, i.gutter, i.rowMode, i.rowHeight)
                                    }
                                })
                            }
                        }).reflow().performance();
    ...
    function() {
        function e(e, t, n) {
            function o(o, r, i) {
                ...
                function d() {
                    function t() {
                        return !o.fontIcon && !o.fontSet && !i.hasOwnProperty("class")
                    }
        ...
        t.module("material.components.icon", ["material.core"]).directive("mdIcon", e), e.$inject = ["$mdIcon", "$mdTheming", "$mdAria"]
    }(),
    function() {
        function e() {}
        ...
        function o(e, n, o, r, i) {
            function a(e) {
                return e = e || "", E[e] ? o.when(E[e].clone()) : v.test(e) ? s(e).then(c(e)) : (-1 == e.indexOf(":") && (e = "$default:" + e), l(e)["catch"](m)["catch"](u)["catch"](p).then(c(e)))
            }
            ...
            function c(t) {
                return function(n) {
                    return E[t] = f(n) ? n : new h(n, e[t]), E[t].clone()
                }
            }
            ...
            var E = {},
                v = /[-a-zA-Z0-9@:%_\+.~#?&//=]{2,256}\.[a-z]{2,4}\b(\/[-a-zA-Z0-9@:%_\+.~#?&//=]*)?/i;
            return h.prototype = {
                clone: g,
                prepare: b
            }, a.fontSet = d, a
    ...
    function() {
        ...
        function o(e, n, o) {
            function r(r, i, a, d) {
                ...
                function m() {
                    ...
                    function a() {
                        if (m.style.height = m.offsetHeight + "px", i.addClass("md-no-flex"), isNaN(p)) {
                            l.style.height = "auto", l.scrollTop = 0;
                            var e = d();
                            e && (l.style.height = e + "px")
                        } else {
                            l.setAttribute("rows", 1), f || (l.style.minHeight = "0", f = i.prop("clientHeight"), l.style.minHeight = null);
                            var t = Math.max(p, Math.round(l.scrollHeight / f));
                            l.setAttribute("rows", t)
                        }
                        i.removeClass("md-no-flex"), m.style.height = "auto"
                    }
                    ...
                    if (!t.isDefined(i.attr("md-no-autogrow"))) {
                        var l = i[0],
                            ...
                            p = 0 / 0,
                            f = null;
                        l.hasAttribute("rows") && (p = parseInt(l.getAttribute("rows")));
                        var h = e.debounce(a, 1);
                        u ? (u.$formatters.push(o), u.$viewChangeListeners.push(o)) : h(), i.on("keydown input", h), isNaN(p) && (i.attr("rows", "1"), i.on("scroll", c)), t.element(n).on("resize", h), r.$on("$destroy", function() {
                ...
                if (s) {
                    if (s.input) throw new Error("<md-input-container> can only have *one* <input>, <textarea> or <md-select> child element!");
                    ...
                    var f = s.isErrorGetter || function() {
                        return u.$invalid && u.$touched
                    };
                    r.$watch(f, s.setInvalid), u.$parsers.push(c), u.$formatters.push(c), i.on("input", l), p || i.on("focus", function(e) {
                        s.setFocused(!0)
                    }).on("blur", function(e) {
                        s.setFocused(!1), l()
        ...
        function r(e) {
            function n(n, o, r, i) {
                ...
                var d, c = i[0],
                    l = i[1],
                    m = t.element('<div class="md-char-counter">');
            ...
            return {
                ...
                compile: function(i, a) {
                    ...
                    function c(n) {
                        ...
                        if (i[0].setAttribute("tabindex", "-1"), i.append(o), p && p.hasAttribute("ng-click")) {
                            e.expect(p, "aria-label");
                            var d = t.element('<md-button class="md-secondary-container md-icon-button">');
                            d.attr("ng-click", p.getAttribute("ng-click")), p.removeAttribute("ng-click"), p.setAttribute("tabindex", "-1"), p.classList.remove("md-secondary"), d.append(p), p = d[0]
                        }
                        p && (p.hasAttribute("ng-click") || a.ngClick && l(p)) && (i.addClass("md-with-secondary"), i.append(p))
                    }
                    ...
                    var s, u, p = i[0].querySelector(".md-secondary");
                    if (i[0].setAttribute("role", "listitem"), a.ngClick) c("button");
                    else {
                        for (var f, h = 0; f = r[h]; ++h)
                            if (u = i[0].querySelector(f)) {
                                s = !0;
                                break
    ...
    function() {
        function e(e) {
            ...
            function o(e, n, o, r) {
                var i = t.element('<div class="md-open-menu-container md-whiteframe-z2"></div>'),
                    a = n.children()[1];
        ...
        function n(e, t, n, o) {
            ...
            this.init = function(e) {
                ...
                t && t.stopPropagation(), a.isOpen = !0, i.setAttribute("aria-expanded", "true"), e.show({
                    scope: o,
                    mdMenuCtrl: a,
                    element: r,
                    target: n[0]
                ...
                a.isOpen && (a.isOpen = !1, i.setAttribute("aria-expanded", "false"), e.hide(), t || n.children()[0].focus())
    ...
    function() {
        function o(o) {
            function r(o, r, a, d, c, l) {
                function m(e, n, i) {
                    function l() {
                        ...
                        t.extend(i, {
                            ...
                            menuContentEl: t.element(n[0].querySelector("md-menu-content")),
                            backdrop: i.hasBackdrop && a.createBackdrop(e, "md-menu-backdrop md-click-catcher")
                        })
                    }
                    ...
                    function m() {
                        i.resizeFn = function() {
                            f(n, i)
                        }, t.element(r).on("resize", i.resizeFn), t.element(r).on("orientationchange", i.resizeFn)
                    }

                    function u() {
                        i.parent.append(n), n.removeClass("md-leave"), o(function() {
                            o(function() {
                                f(n, i), o(function() {
                                    n.addClass("md-active"), i.alreadyOpen = !0, n[0].style[c.CSS.TRANSFORM] = ""
                                })
                            })
                        })
                    }
                    ...
                    function p() {
                        n.addClass("md-clickable"), i.backdrop && i.backdrop.on("click", function(t) {
                            t.preventDefault(), t.stopPropagation(), e.$apply(function() {
                                i.mdMenuCtrl.close(!0)
                            })
                        }), i.menuContentEl.on("keydown", function(t) {
                            e.$apply(function() {
                                switch (t.keyCode) {
                        ...
                        var t = function(t) {
                            ...
                            var r = t.target;
                            do {
                                if (r == i.menuContentEl[0]) return;
                                if (o(r, ["ng-click", "ng-href", "ui-sref"])) {
                                    r.hasAttribute("disabled") || n();
                                    break
                                }
                            } while (r = r.parentNode)
                        };
                        i.menuContentEl[0].addEventListener("click", t, !0);
                        var o = i.menuContentEl[0].querySelector("[md-menu-focus-target]");
                        return o || (o = i.menuContentEl[0].firstElementChild.firstElementChild), o.focus(),
                            function() {
                                n.removeClass("md-clickable"), i.backdrop.off("click"), i.menuContentEl.off("keydown"), i.menuContentEl[0].removeEventListener("click", t, !0)
                            }
                    }
                    return l(i), d.inherit(i.menuContentEl, i.target), m(), i.disableParentScroll && (i.restoreScroll = a.disableScrollAround(i.element)), i.backdrop && (d.inherit(i.backdrop, i.parent), i.parent.append(i.backdrop)), u(), h.waitTransitionEnd(n, {
                        timeout: 370
                    })["finally"](function(e) {
                        return i.cleanupInteraction = p(), e
                    })
                }

                function s(e, t, n, o) {
                    for (var r = a.getClosest(e.target, "MD-MENU-ITEM"), i = a.nodesToArray(t[0].children), d = i.indexOf(r), c = d + o; c >= 0 && c < i.length; c += o) {
                        var l = i[c].firstElementChild || i[c],
                            m = u(l);
                        if (m) break
                    }
                }
                ...
                function p(e, o, i) {
                    return i.isRemoved = !0, o.addClass("md-leave"), i.cleanupInteraction(), t.element(r).off("resize", i.resizeFn), t.element(r).off("orientationchange", i.resizeFn), i.resizeFn = n, h.waitTransitionEnd(o, {
                        timeout: 370
                    })["finally"](function() {
                        o.removeClass("md-active"), i.backdrop && i.backdrop.remove(), o[0].parentNode === i.parent[0] && i.parent[0].removeChild(o[0]), i.restoreScroll && i.restoreScroll()
                    })
                }

                function f(t, n) {
                    function o(e) {
                        e.top = Math.max(Math.min(e.top, g.bottom - m.offsetHeight), g.top), e.left = Math.max(Math.min(e.left, g.right - m.offsetWidth), g.left)
                    }

                    function r() {
                        for (var t = 0; t < s.children.length; ++t)
                            if ("none" != e.getComputedStyle(s.children[t]).display) return s.children[t]
                    }
                    if (!n.isRemoved) {
                        var a, d, l, m = t[0],
                            s = t[0].firstElementChild,
                            u = s.getBoundingClientRect(),
                            p = n.parent[0],
                            f = p.getBoundingClientRect(),
                            h = n.target[0].querySelector("[md-menu-origin]") || n.target[0],
                            b = h.getBoundingClientRect(),
                            g = {
                                left: f.left + i,
                                top: Math.max(f.top, 0) + i,
                                bottom: Math.max(f.bottom, Math.max(f.top, 0) + f.height) - i,
                                right: f.right - i
                            },
                            E = n.mdMenuCtrl.positionMode();
                        if ("target" == E.top || "target" == E.left || "target-right" == E.left) {
                            if (a = r(), !a) throw Error("Error positioning menu. No visible children.");
                            a = a.firstElementChild || a, a = a.querySelector("[md-menu-align-target]") || a, d = a.getBoundingClientRect(), l = {
                        ...
                        switch (E.left) {
                            case "target":
                                v.left = l.left + b.left - d.left, M += "left";
                                break;
                            case "target-right":
                                v.left = b.right - u.width + (u.right - d.right), M += "right";
                                break;
                            default:
                                throw new Error('Invalid target mode "' + E.left + '" specified for md-menu on X axis.')
                        }
                        var $ = n.mdMenuCtrl.offsets();
                        v.top += $.top, v.left += $.left, o(v), t.css({
                            top: v.top + "px",
                            left: v.left + "px"
                        }), m.style[c.CSS.TRANSFORM_ORIGIN] = M, n.alreadyOpen || (m.style[c.CSS.TRANSFORM] = "scale(" + Math.min(b.width / m.offsetWidth, 1) + "," + Math.min(b.height / m.offsetHeight, 1) + ")")
                    }
                }
                var h = a.dom.animator;
                return {
                    parent: "body",
                    onShow: m,
                    onRemove: p,
            ...
            var i = 8;
            return r.$inject = ["$$rAF", "$window", "$mdUtil", "$mdTheming", "$mdConstant", "$document"], o("$mdMenu").setDefaults({
                methods: ["target"],
                options: r
            })
        }
        t.module("material.components.menu").provider("$mdMenu", o), o.$inject = ["$$interimElementProvider"]
    }(),
    function() {
        function e(e, t) {
            function n(e) {
        ...
        function e(e, o, r) {
            ...
            function a(i, a, c) {
                ...
                var l = a[0].querySelector(".md-bar1").style,
                    m = a[0].querySelector(".md-bar2").style,
    ...
    function() {
        function e(e, o, r, i, a, d, c) {
            function l(a, l) {
                ...
                if (m.append('<span class="md-select-icon" aria-hidden="true"></span>'), m.addClass("md-select-value"), m[0].hasAttribute("id") || m.attr("id", "select_value_label_" + o.nextUid()), a.find("md-content").length || a.append(t.element("<md-content>").append(a.contents())), l.mdOnOpen && a.find("md-content").prepend(t.element("<md-progress-circular>").attr("md-mode", "indeterminate").attr("ng-hide", "$$loadingAsyncDone").wrap("<div>").parent()), l.name) {
                    var s = t.element('<select class="md-visually-hidden">');
                    s.attr({
                        name: "." + l.name,
                        "ng-model": l.ngModel,
                        "aria-hidden": "true",
                    ...
                    t.forEach(u, function(e) {
                        ...
                        e.hasAttribute("ng-value") ? n.attr("ng-value", e.getAttribute("ng-value")) : e.hasAttribute("value") && n.attr("value", e.getAttribute("value")), s.append(n)
                    }), a.parent().append(s)
                }
                var p = '<div class="md-select-menu-container"><md-select-menu ' + (t.isDefined(l.multiple) ? "multiple" : "") + ">" + a.html() + "</md-select-menu></div>";
                return a.empty().append(m), l.tabindex = l.tabindex || "0",
                    function(a, l, m, s) {
                        function u() {
                        ...
                        function f() {
                            x && (_ = _ || x.find("md-select-menu").controller("mdSelectMenu"), A.setLabelText(_.selectedLabels()))
                        }
                        ...
                        function b() {
                            ...
                            e.data("$ngModelController", T), e.data("$mdSelectController", A), N = a.$new(), r.inherit(x, l), x[0].setAttribute("class", x[0].getAttribute("class") + " " + l.attr("md-container-class")), x = d(x)(N), _ = x.find("md-select-menu").controller("mdSelectMenu")
                        }
                        ...
                        function g(e) {
                            ...
                            if (-1 != n.indexOf(e.keyCode)) e.preventDefault(), E(e);
                                ...
                                _.isMultiple || _.deselect(Object.keys(_.selected)[0]), _.select(r.hashKey, r.value), _.refreshViewValue(), T.$render()
                            }
                        }
                        ...
                        var v, M, $ = s[0],
                            ...
                            T = s[2],
                            C = s[3],
                            y = l.find("md-select-value"),
                            w = t.isDefined(m.readonly);
                        if ($) {
                            ...
                            var k = $ && $.isErrorGetter || function() {
                                return T.$invalid && T.$touched
                            };
                            a.$watch(k, $.setInvalid)
                        }
                        var x, N, _;
                        if (b(), r(l), m.name && C) {
                            var H = l.parent()[0].querySelector('select[name=".' + m.name + '"]'),
                                S = t.element(H).controller();
                            S && C.$removeControl(S)
                        }
                        var I = T.$render;
                        T.$render = function() {
                            I(), f(), h()
                        }, A.setLabelText = function(e) {
                            A.setIsPlaceholder(!e);
                            var t = m.placeholder || ($ && $.label ? $.label.text() : "");
                            e = e || t || "";
                            var n = y.children().eq(0);
                            n.text(e)
                        }, A.setIsPlaceholder = function(e) {
                            e ? (y.addClass("md-select-placeholder"), $ && $.label && $.label.addClass("md-placeholder md-static")) : (y.removeClass("md-select-placeholder"), $ && $.label && $.label.removeClass("md-placeholder"))
                        }, w || l.on("focus", function(e) {
                            $ && $.element.hasClass("md-input-has-value") && $.setFocused(!0)
                        }).on("blur", function(e) {
                            $ && $.setFocused(!1), h()
                        }), A.triggerClose = function() {
                            c(m.mdOnClose)(a)
                        ...
                        m.$observe("ngMultiple", function(e) {
                            ...
                            O = a.$watch(function() {
                                ...
                                (e !== n || t !== n) && (e ? l.attr("multiple", "multiple") : l.removeAttr("multiple"), x && (_.setMultiple(e), I = T.$render, T.$render = function() {
                                    I(), f()
                                }, _.refreshViewValue(), T.$render()))
                            })
                        }), m.$observe("disabled", function(e) {
                            "string" == typeof e && (e = !0), (M === n || M !== e) && (M = e, e ? (l.attr({
                                tabindex: -1,
                                "aria-disabled": "true"
                            }), l.off("click", E), l.off("keydown", g)) : (l.attr({
                                tabindex: m.tabindex,
                                "aria-disabled": "false"
                            }), l.on("click", E), l.on("keydown", g)))
                        ...
                        l[0].hasAttribute("id") || (D.id = "select_" + o.nextUid()), l.attr(D), a.$on("$destroy", function() {
        ...
        function o(e, o, r) {
            function i(e, n, i, a) {
                ...
                function l(n) {
                    ...
                    if (r && i) {
                        ...
                        var a = m.hashGetter(i.value),
                            d = t.isDefined(m.selected[a]);
                        e.$apply(function() {
            ...
            function a(r, i, a) {
                ...
                m.setMultiple = function(e) {
                    ...
                    var o = m.ngModel;
                    m.isMultiple = e,
                        s && s(), m.isMultiple ? (o.$validators["md-multiple"] = n, o.$render = d, r.$watchCollection(i.ngModel, function(e) {
                            n(e) && d(e)
            ...
            function r(o, r, i, a) {
                ...
                t.isDefined(i.ngValue) ? o.$watch(i.ngValue, d) : t.isDefined(i.value) ? d(i.value) : o.$watch(function() {
                    ...
                    i.$observe("selected", function(e) {
                        t.isDefined(e) && ("string" == typeof e && (e = !0), e ? (m.isMultiple || m.deselect(Object.keys(m.selected)[0]), m.select(l.hashKey, l.value)) : m.deselect(l.hashKey), m.refreshViewValue(), m.ngModel.$render())
                    })
        ...
        function a(e) {
            function o(e, o, a, c, l, m, s, u) {
                function p(r, i, d) {
                    function u() {
                        d.target.attr("aria-expanded", "true")
                    }

                    function p() {
                        function t(e) {
                            f = d.selectEl[0].getElementsByTagName("md-option");
                            var t, o = c.nodesToArray(f),
                                r = o.indexOf(d.focusedNode);
                        ...
                        function l() {
                            m.isMultiple || (d.restoreFocus = !0, c.nextTick(function() {
                                e.hide(m.ngModel.$viewValue)
                            }, !0))
                        }
                        if (!d.isRemoved) {
                            var m = d.selectEl.controller("mdSelectMenu") || {};
                            i.addClass("md-clickable"), d.backdrop && d.backdrop.on("click", function(t) {
                                t.preventDefault(), t.stopPropagation(), d.restoreFocus = !1, c.nextTick(e.hide, !0)
                            }), d.selectEl.on("keydown", function(t) {
                                switch (t.keyCode) {
                                    case o.KEY_CODE.SPACE:
                                    case o.KEY_CODE.ENTER:
                                        var n = c.getClosest(t.target, "md-option");
                                        n && (d.selectEl.triggerHandler({
                                            type: "click",
                                            target: n
                                        }), t.preventDefault());
                                        break;
                                    ...
                                    case o.KEY_CODE.ESCAPE:
                                        t.preventDefault(), d.restoreFocus = !0, c.nextTick(e.hide, !0)
                                }
                            }), d.selectEl.on("keydown", function(e) {
                                switch (e.keyCode) {
                                    ...
                                    default:
                                        if (e.keyCode >= 31 && e.keyCode <= 90) {
                                            var t = d.selectEl.controller("mdSelectMenu").optNodeForKeyboardSearch(e);
                                            d.focusedNode = t || d.focusedNode, t && t.focus()
                                        }
                                }
                            }), d.selectEl.on("click", l), d.selectEl.on("keydown", function(e) {
                                (32 == e.keyCode || 13 == e.keyCode) && l()
                            })
                        }
                    }
                    if (!d.target) throw new Error('$mdSelect.show() expected a target element in options.target but got "' + d.target + '"!');
                    t.extend(d, {
                        isRemoved: !1,
                        target: t.element(d.target),
                        parent: t.element(d.parent),
                        selectEl: i.find("md-select-menu"),
                        contentEl: i.find("md-content"),
                        backdrop: d.hasBackdrop && c.createBackdrop(r, "md-select-backdrop md-click-catcher")
                    }), d.resizeFn = function() {
                        a(function() {
                            a(function() {
                                h(r, i, d)
                    ...
                    }, t.element(m).on("resize", d.resizeFn), t.element(m).on("orientationchange", d.resizeFn), u(), i.removeClass("md-leave");
                    var f = d.selectEl[0].getElementsByTagName("md-option");
                    return d.loadingAsync && d.loadingAsync.then ? d.loadingAsync.then(function() {
                        r.$$loadingAsyncDone = !0, a(function() {
                            a(function() {
                                d.isRemoved || h(r, i, d)
                            })
                        })
                    }) : d.loadingAsync && (r.$$loadingAsyncDone = !0), d.disableParentScroll && !c.getClosest(d.target, "MD-DIALOG") ? d.restoreScroll = c.disableScrollAround(d.element) : d.disableParentScroll = !1, d.backdrop && (l.inherit(d.backdrop, d.target), d.parent.append(d.backdrop)), d.parent.append(i), a(function() {
                        a(function() {
                            d.isRemoved || h(r, i, d)
                        })
                    }), d.isRemoved ? s.reject(!0) : b.waitTransitionEnd(d.selectEl, {
                        timeout: 470
                    })["finally"](function() {
                        p()
                    })
                ...
                function f(e, o, r) {
                    r.isRemoved = !0, r.target.attr("aria-expanded", "false"), r.selectEl.off("keydown"), t.element(m).off("resize", r.resizeFn), t.element(m).off("orientationchange", r.resizefn), r.resizeFn = n, o.addClass("md-leave").removeClass("md-clickable");
                    var i = r.selectEl.controller("mdSelect");
                    return i && i.setLabelText(r.selectEl.controller("mdSelectMenu").selectedLabels()), r.backdrop && r.backdrop.remove(), b.waitTransitionEnd(o, {
                        timeout: 370
                    })["finally"](function() {
                        i && i.triggerClose(), o.removeClass("md-active"), o[0].parentNode === r.parent[0] && r.parent[0].removeChild(o[0]), r.disableParentScroll && r.restoreScroll(), r.restoreFocus && r.target.focus()
                    })
                }

                function h(e, t, n) {
                    var l, s = t[0],
                        u = n.target[0].firstElementChild,
                        p = n.parent[0],
                        f = n.selectEl[0],
                        h = n.contentEl[0],
                        ...
                        T = f.querySelector("md-option[selected]"),
                        C = f.getElementsByTagName("md-option"),
                        y = f.getElementsByTagName("md-optgroup");
                    l = T ? T : y.length ? y[0] : C.length ? C[0] : h.firstElementChild || h, h.offsetWidth > $ && (h.style["max-width"] = $ + "px"), E && (h.style["min-width"] = g.width + "px"), A && f.classList.add("md-overflow");
                    var w = l;
                    "MD-OPTGROUP" === (w.tagName || "").toUpperCase() && (w = C[0] || h.firstElementChild || h, l = w);
                    var k = f.getBoundingClientRect(),
                        x = i(l);
                    if (l) {
                        var N = m.getComputedStyle(l);
                        x.paddingLeft = parseInt(N.paddingLeft, 10) || 0, x.paddingRight = parseInt(N.paddingRight, 10) || 0
                    }
                    if (A) {
                        var _ = h.offsetHeight / 2;
                        h.scrollTop = x.top + x.height / 2 - _, M.top < _ ? h.scrollTop = Math.min(x.top, h.scrollTop + _ - M.top) : M.bottom < _ && (h.scrollTop = Math.max(x.top + x.height - k.height, h.scrollTop - _ + M.bottom))
                    }
                    var H, S, I;
                    E ? (H = g.left, S = g.top + g.height, I = "50% 0", S + k.height > v.bottom && (S = g.top - k.height, I = "50% 100%")) : (H = g.left + x.left - x.paddingLeft + 2, S = Math.floor(g.top + g.height / 2 - x.height / 2 - x.top + h.scrollTop) + 2, I = x.left + g.width / 2 + "px " + (x.top + x.height / 2 - h.scrollTop) + "px 0px", s.style.minWidth = g.width + x.paddingLeft + x.paddingRight + "px");
                    var O = s.getBoundingClientRect();
                    s.style.left = r(v.left, H, v.right - O.width) + "px", s.style.top = r(v.top, S, v.bottom - O.height) + "px", f.style[o.CSS.TRANSFORM_ORIGIN] = I, f.style[o.CSS.TRANSFORM] = "scale(" + Math.min(g.width / k.width, 1) + "," + Math.min(g.height / k.height, 1) + ")", a(function() {
                        t.addClass("md-active"), f.style[o.CSS.TRANSFORM] = "", w && !w.hasAttribute("disabled") && (n.focusedNode = w, w.focus())
                    })
                }
                var b = c.dom.animator;
                return {
                    parent: "body",
                    onShow: p,
                    onRemove: f,
            ...
            return o.$inject = ["$mdSelect", "$mdConstant", "$$rAF", "$mdUtil", "$mdTheming", "$window", "$q", "$compile"], e("$mdSelect").setDefaults({
                methods: ["target"],
                options: o
            })
        }
        ...
        function r(e, o, r, i, a, d, c, l, m, s) {
            function u(d, u, p, f) {
                ...
                function b(e) {
                    var t = u.parent(),
                        n = f.focusElement();
                    return t[e ? "on" : "off"]("keydown", v), w[e ? "on" : "off"]("click", M), e && (A = s[0].activeElement), g(e), T = m.all([e ? a.enter(w, t) : a.leave(w), a[e ? "removeClass" : "addClass"](u, "md-closed")]).then(function() {
                        d.isOpen && n && n.focus()
                    })
                }
                ...
                function E(e) {
                    if (d.isOpen == e) return m.when(!0);
                    var t = m.defer();
                    return d.isOpen = e, o.nextTick(function() {
                        T.then(function(e) {
                            d.isOpen || (A && A.focus(), A = null), t.resolve(e)
                        })
                    }), t.promise
                }
                ...
                u.on("$destroy", f.destroy), i.inherit(w, u), d.$watch(y, h), d.$watch("isOpen", b), f.$toggleOpen = E, f.focusElement(f.focusElement() || u)
            }
            return {
                restrict: "E",
                scope: {
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, l) {
            ...
            function s(o, m, s, u) {
                ...
                function f(e) {
                    G = parseFloat(e), m.attr("aria-valuemin", e), p()
                }

                function h(e) {
                    X = parseFloat(e), m.attr("aria-valuemax", e), p()
                }
                ...
                function E() {
                    if (t.isDefined(s.mdDiscrete) && !t.isUndefined(Q)) {
                        if (0 >= Q) {
                        ...
                        if (!Z) {
                            Z = t.element('<canvas style="position:absolute;">'), U.append(Z);
                            var r = n.getComputedStyle(U[0]);
                ...
                function A(e) {
                    u.$setViewValue(C(y(e)))
                }

                function T() {
                    isNaN(u.$viewValue) && (u.$viewValue = u.$modelValue);
                    var e = (u.$viewValue - G) / (X - G);
                    o.modelValue = u.$viewValue, m.attr("aria-valuenow", u.$viewValue), w(e), z.text(u.$viewValue)
                }
                ...
                function w(e) {
                    V.css("width", 100 * e + "%"), j.css("left", 100 * e + "%"), m.toggleClass("md-min", 0 === e)
                }

                function k(e) {
                    if (!F()) {
                        m.addClass("active"), m[0].focus(), v();
                        var t = R(D(e.pointer.x)),
                            n = C(y(t));
                        o.$apply(function() {
                            A(n), w(L(n))
                        })
                ...
                function N(e) {
                    F() || (te = !0, e.stopPropagation(), m.addClass("dragging"), S(e))
                }
                ...
                function S(e) {
                    ne ? O(e.pointer.x) : I(e.pointer.x)
                }
                ...
                var P = s.ngDisabled && c(s.ngDisabled),
                    F = P ? function() {
                        return P(o.$parent)
                    } : t.noop,
                    B = t.element(m[0].querySelector(".md-thumb")),
                    z = t.element(m[0].querySelector(".md-thumb-text")),
                    j = B.parent(),
                    q = t.element(m[0].querySelector(".md-track-container")),
                    V = t.element(m[0].querySelector(".md-track-fill")),
                    U = t.element(m[0].querySelector(".md-track-ticks")),
                    Y = r.throttle(v, 5e3);
                t.isDefined(s.min) ? s.$observe("min", f) : f(0), t.isDefined(s.max) ? s.$observe("max", h) : h(100), t.isDefined(s.step) ? s.$observe("step", b) : b(1);
                var W = t.noop;
                s.ngDisabled && (W = o.$parent.$watch(s.ngDisabled, g)), d.register(m, "drag"), m.on("keydown", $).on("$md.pressdown", k).on("$md.pressup", x).on("$md.dragstart", N).on("$md.drag", _).on("$md.dragend", H), setTimeout(p);
                var K = e.throttle(p);
                t.element(n).on("resize", K), o.$on("$destroy", function() {
                    t.element(n).off("resize", K), W()
                }), u.$render = T, u.$viewChangeListeners.push(T), u.$formatters.push(C), u.$formatters.push(y);
                var G, X, Q, Z, J, ee = {};
                v();
                var te = !1,
                    ne = t.isDefined(s.mdDiscrete)
            }
            return {
                scope: {},
                require: "?ngModel",
        ...
        function e(e, o, r, i, a) {
            function d(e) {
                function t(e, t) {
                    ...
                    return h.items.push(n), p.parent().prepend(n.clone), f(),
                        function() {
                ...
                function r() {
                    ...
                    for (var e, t = p.prop("scrollTop"), n = h.items.length - 1; n >= 0; n--)
                        if (t > h.items[n].top) {
                            e = h.items[n];
                            break
                        } m(e)
                ...
                var p = e.$element,
                    f = i.throttle(r);
                l(p), p.on("$scrollstart", f), p.on("$scroll", c);
                var h, b = p.prop("offsetTop");
                return h = {
                    prev: null,
                    current: null,
                    next: null,
        ...
        function e(e, n, o, r, i, a, d, c) {
            function l(e, n) {
                ...
                return e.addClass("md-dragging"),
                    function(e, n, l, m) {
                        function s(t) {
                            h(e) || (t.stopPropagation(), n.addClass("md-dragging"), E = {
                        ...
                        }), c.register(g, "drag"), g.on("$md.dragstart", s).on("$md.drag", u).on("$md.dragend", p);
                        var E
                    }
            }
            var m = e[0];
            ...
            function t(e, t, o) {
                function r(r, i, d) {
                    return i = o.extractElementByName(i, "md-toast"), n = d.content, i.addClass(d.position.split(" ").map(function(e) {
                        return "md-" + e
                    }).join(" ")), d.parent.addClass(a(d.position)), d.onSwipe = function(e, n) {
                        i.addClass("md-" + e.type.replace("$md.", "")), o.nextTick(t.cancel)
                    }, i.on("$md.swipeleft $md.swiperight", d.onSwipe), e.enter(i, d.parent)
                }

                function i(t, n, o) {
                    return n.off("$md.swipeleft $md.swiperight", o.onSwipe), o.parent.removeClass(a(o.position)), e.leave(n)
                }
            ...
            return {
                ...
                link: function(d, c, l) {
                    function m() {
                        ...
                        function m(e) {
                            var t = e ? e.target.scrollTop : f;
                            g(), p = Math.min(s / h, Math.max(0, p + t - f)), c.css(n.CSS.TRANSFORM, a([-p * h])), u.css(n.CSS.TRANSFORM, a([(s - p) * h])), f = t, o.nextTick(function() {
                                var e = c.hasClass("md-whiteframe-z1");
                                e && !p ? i.removeClass(c, "md-whiteframe-z1") : !e && p && i.addClass(c, "md-whiteframe-z1")
                            })
                        }
                        var s, u, p = 0,
                            f = 0,
                            h = l.mdShrinkSpeedFactor || .5,
                            b = e.throttle(m),
                            g = o.debounce(r, 5e3);
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, l) {
            function m(m, p, f) {
                function h() {
                    t.isDefined(f.mdDelay) || (m.delay = s)
                }

                function b() {
                    m.$on("$destroy", function() {
                        m.visible = !1, p.remove(), t.element(n).off("resize", I)
                ...
                function g() {
                    k.attr("aria-label") || k.text().trim() || k.attr("aria-label", p.text().trim())
                }

                function E() {
                    p.detach(), p.attr("role", "tooltip")
                }

                function v() {
                    for (var e = p.parent(); e && $("pointer-events", "none", e[0]);) e = e.parent();
                    return e
                }

                function M() {
                    for (var e = p.parent()[0]; e && e !== d[0] && e !== document.body;) e = e.parentNode;
                    return e
                }

                function $(e, o, r) {
                    e = f.$normalize(e), r = r || p[0];
                ...
                function A() {
                    var e = !1,
                        o = function() {
                            k.on("blur mouseleave touchend touchcancel", i), T(!0)
                        },
                        i = function() {
                            var t = m.hasOwnProperty("autohide") ? m.autohide : f.hasOwnProperty("mdAutohide");
                            (t || e || r[0].activeElement !== k[0]) && (k.off("blur mouseleave touchend touchcancel", i), T(!1)), e = !1
                        };
                    k.on("mousedown", function() {
                        e = !0
                    }), k.on("focus mouseenter touchstart", o), t.element(n).on("resize", I)
                }

                function T(t) {
                    T.value = !!t, T.queued || (t ? (T.queued = !0, e(function() {
                        m.visible = T.value, T.queued = !1
                    }, m.delay)) : i.nextTick(function() {
                        m.visible = !1
                    }))
                }

                function C() {
                    return S.append(p), $("display", "none") ? (m.visible = !1, void p.detach()) : (w(), void t.forEach([p, x, N], function(e) {
                        c.addClass(e, "md-show")
                    }))
                }

                function y() {
                    l.all([c.removeClass(N, "md-show"), c.removeClass(x, "md-show"), c.removeClass(p, "md-show")]).then(function() {
                        m.visible || p.detach()
                    })
                }
                ...
                function w() {
                    ...
                    var o = i.offsetRect(p, S),
                        r = i.offsetRect(k, S),
                        a = n(_);
                    _ ? a = t(a) : a.top > p.prop("offsetParent").scrollHeight - o.height - u && (a = t(n("top"))), p.css({
                        top: a.top + "px",
                        left: a.left + "px"
                    }), e()
                }
                a(p);
                var k = v(),
                    x = t.element(p[0].getElementsByClassName("md-background")[0]),
                    N = t.element(p[0].getElementsByClassName("md-content")[0]),
                    _ = f.mdDirection,
                    H = M(),
    ...
    function() {
        ...
        function i(e, t, n, o, r, i) {
            this.$scope = e, this.$element = t, this.$attrs = n, this.$browser = o, this.$document = r, this.$$rAF = i, this.browserCheckUrlChange = o.$$checkUrlChange, this.newStartIndex = 0, this.newEndIndex = 0, this.startIndex = 0, this.endIndex = 0, this.itemSize = e.$eval(n.mdItemSize) || null, this.isFirstRender = !0, this.itemsLength = 0, this.blocks = {}, this.pooledBlocks = []
        }
        ...
        o.$inject = ["$$rAF", "$scope", "$element", "$attrs"], o.prototype.register = function(e) {
            ...
            if (e !== this.scrollOffset) {
                ...
                if (t) {
                    var n = Math.max(0, Math.floor(e / t) - d),
                        o = this.isHorizontal() ? "translateX(" : "translateY(";
                    o += n * t + "px)", this.scrollOffset = e,
                        this.offsetter.style.webkitTransform = o, this.offsetter.style.transform = o, this.repeater.containerUpdated()
                }
            }
        }, r.$inject = ["$parse"], i.$inject = ["$scope", "$element", "$attrs", "$browser", "$document", "$$rAF"], i.Block, i.prototype.link_ = function(e, t, n, o, r) {
            this.container = e, this.transclude = t, this.repeatName = n, this.repeatListExpression = o, this.extraName = r, this.sized = !1, this.container.register(this)
            ...
            this.itemSize = e.element[0][this.container.isHorizontal() ? "offsetWidth" : "offsetHeight"] || null, this.blocks[0] = e, this.poolBlock_(0), this.itemSize && this.containerUpdated()
            ...
            if (this.items = e, e !== n && this.updateIndexes_(), this.parentNode = this.$element[0].parentNode, r && this.container.setScrollSize(o * this.itemSize), this.isFirstRender) {
            ...
            for (var m = a - 1; a < this.newEndIndex; a++) d = this.getBlock_(a), this.updateBlock_(d, a), l.push(d);
            ...
            this.newStartIndex = Math.max(0, Math.min(e - t, Math.floor(this.container.getScrollOffset() / this.itemSize))), this.newEndIndex = Math.min(e, this.newStartIndex + t + d), this.newStartIndex = Math.max(0, this.newStartIndex - d)
        }
    }(),
    function() {
    ...
    function() {
        function e(e, o, a, d, c, l, m, s, u, p) {
            function f() {
            ...
            function h() {
                function e() {
                    var e = ne.ul.getBoundingClientRect(),
                        n = {};
                    e.right > o.right - i && (n.left = t.right - e.width + "px"), ne.$.ul.css(n)
                }
                if (!ne) return a.nextTick(h, !1);
                var t = ne.wrap.getBoundingClientRect(),
                    n = ne.snap.getBoundingClientRect(),
                    o = ne.root.getBoundingClientRect(),
                    d = n.bottom - o.top,
                    c = o.bottom - n.top,
                    l = t.left - o.left,
                    m = t.width,
                ...
                d > c && o.height - t.bottom - i < r ? (s.top = "auto", s.bottom = c + "px", s.maxHeight = Math.min(r, t.top - o.top - i) + "px") : (s.top = d + "px", s.bottom = "auto", s.maxHeight = Math.min(r, o.bottom - t.bottom - i) + "px"), ne.$.ul.css(s), a.nextTick(e, !1)
            }

            function b() {
                ne.$.root.length && (c(ne.$.ul), ne.$.ul.detach(), ne.$.root.append(ne.$.ul), m.pin && m.pin(ne.$.ul, s))
            }

            function g() {
                e.autofocus && ne.input.focus()
            }
            ...
            function E() {
                ...
                u.$observe("disabled", function(e) {
                    ...
                    J.isRequired = null !== e
                }), e.$watch("searchText", n ? a.debounce(I, n) : I), e.$watch("selectedItem", k), t.element(l).on("resize", h), e.$on("$destroy", v)
            }

            function v() {
                t.element(l).off("resize", h), ne.$.ul.remove()
            }
            ...
            function M() {
                ne = {
                    ...
                    root: document.body
                }, ne.li = ne.ul.getElementsByTagName("li"), ne.snap = $(), ne.$ = A(ne)
            }
            ...
            function T(e, t) {
                !e && t ? (h(), ne && a.nextTick(function() {
                    a.disableScrollAround(ne.ul)
            ...
            function S(e) {
                var t = ie.indexOf(e); - 1 != t && ie.splice(t, 1)
            }

            function I(t, n) {
                J.index = B(), t !== n && P(e.selectedItem).then(function(o) {
                    t !== o && (e.selectedItem = null, t !== n && N(), q() ? Q() : (J.loading = !1, J.matches = [], J.hidden = z(), K()))
                })
            }
            ...
            function D() {
                ae = !0, t.isString(e.searchText) || (e.searchText = ""), e.minLength > 0 || (J.hidden = z(), J.hidden || Q())
            }
            ...
            function R(e) {
                switch (e.keyCode) {
                    case d.KEY_CODE.DOWN_ARROW:
                        if (J.loading) return;
                        e.stopPropagation(), e.preventDefault(), J.index = Math.min(J.index + 1, J.matches.length - 1), X(), K();
                        break;
                    case d.KEY_CODE.UP_ARROW:
                        if (J.loading) return;
                        e.stopPropagation(), e.preventDefault(), J.index = J.index < 0 ? J.matches.length - 1 : Math.max(0, J.index - 1), X(), K();
                        break;
                    case d.KEY_CODE.TAB:
                    case d.KEY_CODE.ENTER:
                        if (J.hidden || J.loading || J.index < 0 || J.matches.length < 1) return;
                        e.stopPropagation(), e.preventDefault(), U(J.index);
                        break;
                    case d.KEY_CODE.ESCAPE:
                        e.stopPropagation(), e.preventDefault(), Y(), J.matches = [], J.hidden = !0, J.index = B()
                }
            }
            ...
            function F(e) {
                if (!e) return n;
                var t = {};
                return J.itemName && (t[J.itemName] = e), t
            }
            ...
            function z() {
                return q() && J.matches.length ? void 0 : !0
            }

            function j() {
                return P(J.matches[J.index])
            }
            ...
            function U(t) {
                a.nextTick(function() {
                    P(J.matches[t]).then(function(e) {
                        var t = ne.$.input.controller("ngModel");
                        t.$setViewValue(e), t.$render()
                    })["finally"](function() {
                        e.selectedItem = J.matches[t], J.loading = !1, J.hidden = !0, J.index = 0, J.matches = []
                    })
                }, !1)
            }
            ...
            function Y() {
                ...
                t.initCustomEvent("input", !0, !0, {
                    value: e.searchText
                }), ne.input.dispatchEvent(t), ne.input.focus()
            }

            function W(n) {
                function o(t) {
                    oe[i] = t, n === e.searchText && (J.matches = t, J.hidden = z(), e.selectOnMatch && Z(), K(), h())
                }
                var r = e.$parent.$eval(te),
                    i = n.toLowerCase();
                t.isArray(r) ? o(r) : r && a.nextTick(function() {
                    J.loading = !0, r.success && r.success(o), r.then && r.then(o), r["finally"] && r["finally"](function() {
                        J.loading = !1
                    })
                })
            }
            ...
            function G() {
                if (de === J.matches.length) return "";
                switch (de = J.matches.length, J.matches.length) {
                    case 0:
                        return "There are no matches available.";
                    case 1:
                        return "There is 1 match available.";
                    default:
                        return "There are " + J.matches.length + " matches available."
                }
            }
            ...
            function X() {
                if (ne.li[J.index]) {
                    var e = ne.li[J.index],
                        t = e.offsetTop,
                        n = t + e.offsetHeight,
                        o = ne.ul.clientHeight;
                    t < ne.ul.scrollTop ? ne.ul.scrollTop = t : n > ne.ul.scrollTop + o && (ne.ul.scrollTop = n - o)
                }
            }
            ...
            function Q() {
                var t = e.searchText,
                    n = t.toLowerCase();
                !e.noCache && oe[n] ? (J.matches = oe[n], K()) : W(t), ae && (J.hidden = z())
            }
    ...
    function() {
        function e(e, n, o) {
            ...
            function i(t, n) {
                ...
                m.watchers.push(e.$watch(t, function(e) {
                    m.term = e, d(e, m.template)
                })), m.watchers.push(e.$watch(r, function(e) {
                    m.template = e, d(m.term, e)
                }))
            }

            function a() {
                m.watchers.forEach(function(e) {
                    e()
                })
            }

            function d() {
                if (null !== m.term && null !== m.template) {
                    var r = o(m.template)(e),
                        i = t.element("<div>").text(r).html(),
                        a = n.attr("md-highlight-flags") || "",
                        d = l(m.term, a),
                        c = i.replace(d, '<span class="highlight">$&</span>');
                    n.html(c)
                }
            }
            ...
            function l(e, t) {
                var n = "";
                return t.indexOf("^") >= 1 && (n += "^"), n += e, t.indexOf("$") >= 1 && (n += "$"), new RegExp(c(n), t.replace(/[\$\^]/g, ""))
            }
            var m = this;
            m.term = null, m.template = null, m.watchers = [], m.init = r
        }
    ...
    function() {
        function e(e, t, a, d, c) {
            function l(n, l) {
                ...
                var u = m("md-chips>*[md-chip-remove]") || i,
                    p = m("md-chips>md-chip-template") || r,
                    f = m("md-chips>md-autocomplete") || m("md-chips>input") || o,
                    h = s.find("md-chip");
                return s[0].querySelector("md-chip-template>*[md-chip-remove]") && d.warn("invalid placement of md-chip-remove within md-chip-template."),
                    function(n, r, i, d) {
                        t.initOptionalProperties(n, l), e(r);
                        var m = d[0];
                        if (m.chipContentsTemplate = p, m.chipRemoveTemplate = u, m.chipInputTemplate = f, r.attr({
                                ariaHidden: !0,
                                tabindex: -1
                            }).on("focus", function() {
                                m.onFocus()
                            }), l.ngModel && (m.configureNgModel(r.controller("ngModel")), i.mdOnAppend && m.useMdOnAppendExpression(), f != o && c(function() {
                                0 === f.indexOf("<md-autocomplete") && m.configureAutocomplete(r.find("md-autocomplete").controller("mdAutocomplete")), m.configureUserInput(r.find("input"))
                            })), h.length > 0) {
                            var s = a(h)(n.$parent);
                            c(function() {
    ...
    function() {
        function e() {
            function e(e, n, o, r) {
                if (r) {
                    var i = n.parent()[0].getElementsByTagName("md-tab"),
                        a = Array.prototype.indexOf.call(i, n[0]),
                        d = n.find("md-tab-body").eq(0).remove(),
                        c = n.find("md-tab-label").eq(0).remove(),
                        l = r.insertTab({
                            scope: e,
                            parent: e.$parent,
                            index: a,
    ...
    function() {
        function e(e, n, o, r, i, a, d, c, l, m) {
            function s() {
                ie.selectedIndex = ie.selectedIndex || 0, u(), f(), p(), m(n), a.nextTick(function() {
                    ee(), X(), te(), ie.tabs[ie.selectedIndex] && ie.tabs[ie.selectedIndex].scope.select(), me = !0, U()
                })
            }
            ...
            function u() {
                var e = c.$mdTabsTemplate,
                    n = t.element(de.data);
                n.html(e), l(n.contents())(ie.parent), delete c.$mdTabsTemplate
            }

            function p() {
                t.element(o).on("resize", S), e.$on("$destroy", g)
            }
            ...
            function g() {
                le = !0, t.element(o).off("resize", S)
            }

            function E(e) {
                t.element(de.wrapper).toggleClass("md-stretch-tabs", B()), te()
            }

            function v(e) {
                ie.shouldCenterTabs = z()
            }

            function M(e, t) {
                e !== t && a.nextTick(ie.updateInkBarStyles)
            }

            function $(e, t) {
                e !== t && (ie.maxTabWidth = Y(), ie.shouldCenterTabs = z(), a.nextTick(function() {
                    ie.maxTabWidth = Y(), X(ie.selectedIndex)
                }))
            }
            ...
            function T(n) {
                var o = ie.shouldCenterTabs ? "" : "-" + n + "px";
                t.element(de.paging).css(r.CSS.TRANSFORM, "translate3d(" + o + ", 0, 0)"), e.$broadcast("$mdTabsPaginationChanged")
            }
            ...
            function y(t, n) {
                t !== n && (ie.selectedIndex = q(t), ie.lastSelectedIndex = n, ie.updateInkBarStyles(), ee(), X(t), e.$broadcast("$mdTabsChanged"), ie.tabs[n] && ie.tabs[n].scope.deselect(), ie.tabs[t] && ie.tabs[t].scope.select())
            }

            function w() {
                w.watcher || (w.watcher = e.$watch(function() {
                    a.nextTick(function() {
                        w.watcher && n.prop("offsetParent") && (w.watcher(), w.watcher = null, S())
                    }, !1)
                }))
            }
            ...
            function k(e) {
                switch (e.keyCode) {
                    ...
                    case r.KEY_CODE.ENTER:
                        e.preventDefault(), ae || (ie.selectedIndex = ie.focusIndex)
                }
                ie.lastClick = !1
            }

            function x(e) {
                ae || (ie.focusIndex = ie.selectedIndex = e), ie.lastClick = !0, a.nextTick(function() {
                    ie.tabs[e].element.triggerHandler("click")
                }, !1)
            }

            function N(e) {
                ie.shouldPaginate && (e.preventDefault(), ie.offsetLeft = oe(ie.offsetLeft - e.wheelDelta))
            }

            function _() {
                var e, t, n = de.canvas.clientWidth,
                    o = n + ie.offsetLeft;
                for (e = 0; e < de.tabs.length && (t = de.tabs[e], !(t.offsetLeft + t.offsetWidth > o)); e++);
                ie.offsetLeft = oe(t.offsetLeft)
            }

            function H() {
                var e, t;
                for (e = 0; e < de.tabs.length && (t = de.tabs[e], !(t.offsetLeft + t.offsetWidth >= ie.offsetLeft)); e++);
                ie.offsetLeft = oe(t.offsetLeft + t.offsetWidth - de.canvas.clientWidth)
            }

            function S() {
                e.$apply(function() {
                    ie.lastSelectedIndex = ie.selectedIndex, ie.offsetLeft = oe(ie.offsetLeft), a.nextTick(ie.updateInkBarStyles, !1), a.nextTick(U)
                })
            }
            ...
            function D(e) {
                if (!le) {
                    var t = ie.selectedIndex,
                        n = ie.tabs.splice(e.getIndex(), 1)[0];
                    J(), ie.selectedIndex === t && (n.scope.deselect(), ie.tabs[ie.selectedIndex] && ie.tabs[ie.selectedIndex].scope.select()), a.nextTick(function() {
                        U(), ie.offsetLeft = oe(ie.offsetLeft)
                    })
                }
            }
            ...
            function R(e, n) {
                var o = me,
                    ...
                    i = t.extend(r, e);
                return t.isDefined(n) ? ie.tabs.splice(n, 0, i) : ie.tabs.push(i), Q(), Z(), a.nextTick(function() {
                    U(), o && ie.autoselect && a.nextTick(function() {
                        a.nextTick(function() {
                            x(ie.tabs.indexOf(i))
                        })
                    })
            ...
            function F() {
                ...
                return e && e.offsetLeft + e.offsetWidth > de.canvas.clientWidth + ie.offsetLeft
            }
            ...
            function B() {
                switch (ie.stretchTabs) {
                    ...
                    case "never":
                        return !1;
                    default:
                        return !ie.shouldPaginate && o.matchMedia("(max-width: 600px)").matches
                }
            }
            ...
            function j() {
                ...
                var e = Math.min(n.prop("clientWidth"), ie.maxTabWidth);
            ...
            function q(e) {
                if (-1 === e) return -1;
                var t, n, o = Math.max(ie.tabs.length - e, e);
                for (t = 0; o >= t; t++) {
            ...
            function W() {
                var e = ie.tabs[ie.selectedIndex],
                    t = ie.tabs[ie.focusIndex];
            ...
            function K(e, t) {
                var n, o = t ? "focusIndex" : "selectedIndex",
                    r = ie[o];
                for (n = r + e; ie.tabs[n] && ie.tabs[n].scope.disabled; n += e);
                ie.tabs[n] && (ie[o] = n)
            }

            function G() {
                de.dummies[ie.focusIndex].focus()
            }

            function X(e) {
                if (null == e && (e = ie.focusIndex), de.tabs[e] && !ie.shouldCenterTabs) {
                    var t = de.tabs[e],
                        n = t.offsetLeft,
                        o = t.offsetWidth + n;
                    ie.offsetLeft = Math.max(ie.offsetLeft, oe(o - de.canvas.clientWidth)), ie.offsetLeft = Math.min(ie.offsetLeft, oe(n))
                }
            }
            ...
            function Z() {
                var e = !1;
                t.forEach(ie.tabs, function(t) {
                    t.template && (e = !0)
                }), ie.hasContent = e
            }

            function J() {
                ie.selectedIndex = q(ie.selectedIndex), ie.focusIndex = q(ie.focusIndex)
            }

            function ee() {
                if (!ie.dynamicHeight) return n.css("height", "");
                if (!ie.tabs.length) return ce.push(ee);
                var e = de.contents[ie.selectedIndex],
                    t = e ? e.offsetHeight : 0,
                    o = de.wrapper.offsetHeight,
                    r = t + o,
                    i = n.prop("clientHeight");
                i !== r && (ae = !0, d.animate(n, {
                    height: i + "px"
                }, {
                    height: r + "px"
                }).then(function() {
            ...
            function te() {
                if (de.tabs[ie.selectedIndex]) {
                    if (!ie.tabs.length) return ce.push(ie.updateInkBarStyles);
                    if (!n.prop("offsetParent")) return w();
                    var e, o = ie.selectedIndex,
                        r = de.paging.offsetWidth,
                        i = de.tabs[o],
                        d = i.offsetLeft,
                        c = r - d - i.offsetWidth;
                    ie.shouldCenterTabs && (e = Array.prototype.slice.call(de.tabs).reduce(function(e, t) {
                        return e + t.offsetWidth
                    }, 0), r > e && a.nextTick(te, !1)), ne(), t.element(de.inkBar).css({
                        left: d + "px",
                        right: c + "px"
                    })
                }
            ...
            function ne() {
                var e = ie.selectedIndex,
                    n = ie.lastSelectedIndex,
                    o = t.element(de.inkBar);
                t.isNumber(n) && o.toggleClass("md-left", n > e).toggleClass("md-right", e > n)
            }

            function oe(e) {
                if (!de.tabs.length || !ie.shouldPaginate) return 0;
    ...
    function() {
        ...
        t.module("material.components.tabs").directive("mdTemplate", e), e.$inject = ["$compile", "$mdUtil"]
    }(),
    function() {
